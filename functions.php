...
function bp_add_theme_scripts(){
  //adding styles
    wp_enqueue_style('bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css', array(), '4.0' );
    wp_enqueue_style( 'style', get_stylesheet_uri(), array(), '1.0' );

  //adding script
    wp_register_script( 'jquery', 'https://code.jquery.com/jquery-3.3.1.slim.min.js', array());
    wp_register_script( 'popper', 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.3/umd/popper.min.js', array());
    wp_register_script( 'bootsrap-js', 'https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js', array());

    wp_enqueue_script( 'jquery');
    wp_enqueue_script( 'popper');
    wp_enqueue_script( 'bootsrap-js');
}

add_action( 'wp_enqueue_scripts', 'bp_add_theme_scripts' );
...
function init_widgets($id){
  register_sidebar(
    array(
      ...
      'before_title' => '<div class="card-header"><h3 class="card-title">',
